...
namespace Infiniminer.States
{
    class SettingsState : State
    {
        ...
        public override void OnEnter(string oldState)
        {
            ...
            //Load the background
            texSettings = _SM.Content.LoadTexture("menus/tex_menu_settings");
        ...
        public override void OnRenderAtUpdate(double gameTime)
        {
            ...
            _SM.RenderContext.Renderer2D.DrawImageStretched(texSettings, drawRect, Color4.White);
            //spriteBatch.End();
            foreach (InterfaceElement element in elements)
            {
                element.Render(_SM.RenderContext);
            }
        }
    }
}
