...
namespace Infiniminer
{
    public class KeyBindHandler
    {
        ...
        public KeyBindHandler(InfiniminerGame game)
        {
            this.game = game;
        }
                ...
                if (mouseBinds[mb] == button)
                {
                    switch (mb)
                    {
                        case MouseButton.LeftButton:
                            return game.Mouse.IsButtonDown(MouseButtons.Left);
                        case MouseButton.MiddleButton:
                            return game.Mouse.IsButtonDown(MouseButtons.Middle);
                        case MouseButton.RightButton:
                            return game.Mouse.IsButtonDown(MouseButtons.Right);
                    }
                }
            }
                ...
                if (specialKeyBinds[key] == button)
                {
                    switch (key)
                    {
                        case SpecialKeys.Alt:
                            if (game.Keyboard.IsKeyDown(Keys.LeftAlt) || game.Keyboard.IsKeyDown(Keys.RightAlt))
                                return true;
                            break;
                        case SpecialKeys.Control:
                            if (game.Keyboard.IsKeyDown(Keys.LeftControl) || game.Keyboard.IsKeyDown(Keys.RightControl))
                                return true;
                            break;
